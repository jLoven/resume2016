...
\begin{minipage}[t]{0.66\textwidth} 
  ...
  \begin{tabular}{|l}
    \begin{minipage}{\textwidth}
      \runsubsection{Klasp} \descript{| Jewelry Clasp for Loss of Hand
        Dexterity} \location{3D-printing with embedded magnets} Designed and
      3D-printed a novel magnet-based jewelry clasp for arthritic users.
  ...
  \location{See github.com/jLoven \quad \// \quad jackieloven.com}
