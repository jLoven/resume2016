  ...
  \begin{tabular}{|l}
    \begin{minipage}{\textwidth}
      \runsubsection{Klasp} \descript{| Jewelry Clasp for Loss of Hand
        ...
        /begin{large}
        Designed and 3D-printed a novel magnet-based jewelry clasp for arthritic users.
      Presented at the 2013 Easter Seals Assistive Technology Expo. 
       %end{large}
      \sectionsep
            \end{large}
     ...
     % \begin{large}
      Designed, 3D-printed, and sold a novel and cheap
